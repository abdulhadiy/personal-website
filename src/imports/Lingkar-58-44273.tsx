...
import svgPaths from "./svg-6fg8gibk67";
      ...
      <div className={`absolute content-stretch flex flex-col items-start left-0 w-[510px] ${state === "5" ? "bottom-0" : is4 ? "top-[-1503px]" : state === "3" ? "top-[-1002px]" : state === "2" ? "top-[-501px]" : "top-0"}`}>
                    ...
                    <div className="-scale-y-100 flex-none rotate-180">
                      <div className="content-stretch flex flex-col gap-[8px] items-start relative" data-name="name">
                        <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
                          <LingkarBadge>
                            <p className={`font-["Inter:Medium",sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center whitespace-nowrap ${is4 ? "text-white" : "text-[#414651]"}`}>{is4 ? "bekasi" : is2Or3Or5 ? "Label" : "Label"}</p>
                          </LingkarBadge>
                          <LingkarBadge>
                            <p className={`font-["Inter:Medium",sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center whitespace-nowrap ${is4 ? "text-white" : "text-[#414651]"}`}>{is4 ? "arsitek" : is2Or3Or5 ? "Label" : "Label"}</p>
                          </LingkarBadge>
                        </div>
        ...
        <div className="aspect-[650/650] overflow-clip relative shrink-0 w-full" data-name="bibit">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute content-center flex flex-wrap gap-[15px] items-center justify-center left-1/2 top-[calc(50%+0.26px)] w-[480px]">
            ...
            <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
              <LingkarBadge>
                <p className={`font-["Inter:Medium",sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center whitespace-nowrap ${is4 ? "text-white" : "text-[#414651]"}`}>{is4 ? "Cibubur" : is2Or3Or5 ? "Label" : "Label"}</p>
              </LingkarBadge>
              <LingkarBadge>
                <p className={`font-["Inter:Medium",sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center whitespace-nowrap ${is4 ? "text-white" : "text-[#414651]"}`}>{is4 ? "Interior" : is2Or3Or5 ? "Label" : "Label"}</p>
              </LingkarBadge>
              <LingkarBadge>
                <p className={`font-["Inter:Medium",sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-center whitespace-nowrap ${is4 ? "text-white" : "text-[#414651]"}`}>{is4 ? "2025" : is2Or3Or5 ? "Label" : "Label"}</p>
              </LingkarBadge>
            </div>
            <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
        ...
        <div className="aspect-[650/650] overflow-clip relative shrink-0 w-full" data-name="bibit">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute content-center flex flex-wrap gap-[72px] items-center justify-center left-1/2 top-1/2">
            <div className="flex items-center justify-center relative shrink-0">
              <div className="-scale-y-100 flex-none rotate-180">
                <div className="overflow-clip relative size-[72px]" data-name="arrow-left">
                  <div className="absolute inset-[20.83%]" data-name="Icon">
                    <div className={`absolute ${is4 ? "inset-[-3.57%]" : "inset-[-7.14%]"}`}>
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 45 45" : "0 0 16 16"}>
                        <path d={is4 ? svgPaths.p338d6c00 : "M15 8H1M1 8L8 15M1 8L8 1"} id="Icon" stroke={is4 ? "var(--stroke-0, white)" : "var(--stroke-0, #535862)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "3" : "2"} />
                      </svg>
                    </div>
                  </div>
                </div>
            ...
            <div className="overflow-clip relative shrink-0 size-[72px]" data-name="x-close">
              <div className="absolute inset-1/4" data-name="Icon">
                <div className={`absolute ${is4 ? "inset-[-4.17%]" : "inset-[-8.33%]"}`}>
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 39 39" : "0 0 14 14"}>
                    <path d={is4 ? svgPaths.p3aa5fd00 : "M13 1L1 13M1 1L13 13"} id="Icon" stroke={is4 ? "var(--stroke-0, white)" : "var(--stroke-0, #535862)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "3" : "2"} />
                  </svg>
                </div>
              </div>
            </div>
            <div className="overflow-clip relative shrink-0 size-[72px]" data-name="mail-02">
              <div className="absolute inset-[16.67%_8.33%]" data-name="Icon">
                <div className={`absolute ${is4 ? "inset-[-3.13%_-2.5%_-3.12%_-2.5%]" : "inset-[-6.25%_-5%]"}`}>
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 63.0003 51" : "0 0 22.0002 18"}>
                    <path d={is4 ? svgPaths.p2f1c8700 : svgPaths.p3533db80} id="Icon" stroke={is4 ? "var(--stroke-0, white)" : "var(--stroke-0, #535862)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "3" : "2"} />
                  </svg>
                </div>
              </div>
            </div>
...
export default function Lingkar1() {
  return <Lingkar className="bg-white relative size-full" state="4" />;
}