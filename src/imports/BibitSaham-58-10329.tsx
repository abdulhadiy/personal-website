...
import svgPaths from "./svg-f2l4loj64r";
...
import imgImagesExample3 from "figma:asset/9f2cb679bad3b82745ce1d6db799dfececcf3608.png";
import imgImagesExample1 from "figma:asset/b84eeb12675829a14adb55ba8ec9073c80f3eb27.png";
import imgImagesExample5 from "figma:asset/64d163f97cad1707585350f0c17cb2b8fe9b0c0d.png";
...
import { imgImagesExample2, imgImagesExample4, imgShutterstock17164940261, imgShutterstock1779839804 } from "./svg-oblt2";

function BibitSahamHelper3({ children }: React.PropsWithChildren<{}>) {
  return (
            ...
            <Wrapper2>
              ...
              <div className="content-stretch flex flex-col gap-[17.194px] items-start p-[11.463px] relative rounded-[2.866px] shrink-0">
                <div className="content-stretch flex gap-[34.388px] items-center relative shrink-0 w-[217.075px]">
                  ...
                  <div className="content-stretch flex gap-[4.299px] items-center justify-end relative shrink-0 w-[136.836px]">
                    <Wrapper>
                      <div className={`absolute ${is4 ? "flex inset-[45%_16.67%] items-center justify-center" : "bg-[#00ab6b] inset-[16.67%_45%] rounded-[10px]"}`}>
                        {is4 && (
                          <div className="flex-none h-[8.597px] rotate-90 w-[1.29px]">
                            <div className="bg-[#00ab6b] rounded-[10px] size-full" />
                          </div>
                      ...
                      {is1Or2Or3Or5 && <BibitSahamHelper2 />}
                    </Wrapper>
              ...
              <BibitSahamSlider>
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Slider">
                  ...
                  <div className="col-1 ml-0 mt-0 relative row-1 size-[17.194px]" data-name="Used">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 17.194 17.194" : "0 0 24 24"}>
                      <g id="Used">
                        <circle cx={is4 ? "8.59702" : "12"} cy={is4 ? "8.59702" : "12"} fill="var(--fill-0, white)" id="Ellipse 771" r={is4 ? "7.8806" : "11"} stroke="var(--stroke-0, #B5B5B5)" strokeWidth={is4 ? "1.43284" : "2"} />
                      </g>
                    </svg>
                  </div>
                </div>
            ...
            <Wrapper2>
              ...
              <BibitSahamSlider>
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Slider">
                  ...
                  <div className="col-1 ml-[172.66px] mt-0 relative row-1 size-[17.194px]" data-name="Used">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 17.194 17.194" : "0 0 24 24"}>
                      <g id="Used">
                        <circle cx={is4 ? "8.59702" : "12"} cy={is4 ? "8.59702" : "12"} fill="var(--fill-0, white)" id="Ellipse 771" r={is4 ? "7.8806" : "11"} stroke="var(--stroke-0, #00AB6B)" strokeWidth={is4 ? "1.43284" : "2"} />
                      </g>
                    </svg>
                  </div>
                </div>
                  ...
                  <div className="content-stretch flex flex-col gap-[15.36px] items-center justify-center pb-[12.8px] pt-[25.6px] px-[12.8px] relative w-full">
                    <div className="h-[76.8px] relative shrink-0 w-[115.2px]" data-name="Bibit Saham">
                      <div className="absolute inset-[5.7%_-0.01%_12.36%_0.1%]" data-name="Illustration">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 115.096 62.9248" : "0 0 179.837 98.32"}>
                          <g id="Illustration">
                            <path d={is4 ? svgPaths.p11e96180 : svgPaths.p19a50e80} fill="var(--fill-0, #D9F3E9)" id="Vector" />
                            <path d={is4 ? svgPaths.p16160300 : svgPaths.pfb24500} fill="var(--fill-0, #9FD7C2)" id="Vector_2" />
                            <path d={is4 ? svgPaths.p19473e00 : svgPaths.p2cbb1b00} fill="var(--fill-0, #9FD7C2)" id="Vector_3" />
                            <path d={is4 ? svgPaths.p390dbf00 : svgPaths.p2e6c5600} fill="var(--fill-0, white)" id="Vector_4" />
                            <path d={is4 ? svgPaths.p380a3300 : svgPaths.p28e36d80} fill="var(--fill-0, #007D43)" id="Vector_5" />
                            <path d={is4 ? svgPaths.p26f098f0 : svgPaths.p131ffa00} fill="var(--fill-0, #9FD7C2)" id="Vector_6" />
                            <path d={is4 ? svgPaths.p3173dec0 : svgPaths.p30f6e180} fill="var(--fill-0, #007D43)" id="Vector_7" />
                            <path d={is4 ? svgPaths.p17c57000 : svgPaths.p88f3c80} fill="var(--fill-0, #D9F3E9)" id="Vector_8" />
                            <path d={is4 ? svgPaths.p3b918dc0 : svgPaths.p2b92bf00} fill="var(--fill-0, white)" id="Vector_9" />
                            <path d={is4 ? svgPaths.p3b918dc0 : svgPaths.p2b92bf00} fill="var(--fill-0, white)" id="Vector_10" />
                            <path d={is4 ? svgPaths.p245a980 : svgPaths.pd920400} fill="var(--fill-0, #007D43)" id="Vector_11" />
                            <path d={is4 ? svgPaths.p2b29400 : svgPaths.p3e28a350} fill="var(--fill-0, #007D43)" id="Vector_12" />
                            <path d={is4 ? svgPaths.p223c4c00 : svgPaths.p1bb38780} fill="var(--fill-0, #00AB6B)" id="Vector_13" />
                            <path d={is4 ? svgPaths.p1717e200 : svgPaths.p23b178f0} fill="var(--fill-0, #007D43)" id="Vector_14" />
                            <path d={is4 ? svgPaths.pc7e3800 : svgPaths.p22d7f280} fill="var(--fill-0, #D9F3E9)" id="Vector_15" />
                            <path d={is4 ? svgPaths.p18adc200 : svgPaths.p37c14800} fill="var(--fill-0, #D9F3E9)" id="Vector_16" />
                            <path d={is4 ? svgPaths.p10c2e000 : svgPaths.p2e214a00} fill="var(--fill-0, white)" id="Vector_17" />
                            <path d={is4 ? svgPaths.p10c2e000 : svgPaths.p2e214a00} fill="var(--fill-0, white)" id="Vector_18" />
                            <path d={is4 ? svgPaths.p147d2d00 : svgPaths.p38bb4d00} fill="var(--fill-0, #007D43)" id="Vector_19" />
                            <path d={is4 ? svgPaths.p3b67b100 : svgPaths.p1ae03480} fill="var(--fill-0, white)" id="Vector_20" />
                            <path d={is4 ? svgPaths.p35f8b700 : svgPaths.p342b8300} fill="var(--fill-0, #007D43)" id="Vector_21" />
                            <path d={is4 ? svgPaths.p339f0c00 : svgPaths.pd67a200} fill="var(--fill-0, #90DEC0)" id="Vector_22" />
                            <path d={is4 ? svgPaths.p349e0b80 : svgPaths.p15856a80} fill="var(--fill-0, #007D43)" id="Vector_23" />
                            <path d={is4 ? svgPaths.p3846f800 : svgPaths.p13a1d900} fill="var(--fill-0, #00AB6B)" id="Vector_24" />
                            <path d={is4 ? svgPaths.p2f764980 : svgPaths.p3786a100} fill="var(--fill-0, #00AB6B)" id="Vector_25" />
                            <path d={is4 ? svgPaths.p19835b80 : svgPaths.p2e246600} fill="var(--fill-0, #00AB6B)" id="Vector_26" />
                            <path d={is4 ? svgPaths.p35b0ea80 : svgPaths.p15ad7a30} fill="var(--fill-0, #00AB6B)" id="Vector_27" />
                            <path d={is4 ? svgPaths.p1afe2f0 : svgPaths.p2603720} fill="var(--fill-0, #00AB6B)" id="Vector_28" />
                            <path d={is4 ? svgPaths.p20befb00 : svgPaths.p23d94f80} fill="var(--fill-0, #00AB6B)" id="Vector_29" />
                            <path d={is4 ? svgPaths.p22f2f00 : svgPaths.p1412e00} fill="var(--fill-0, #90DEC0)" id="Vector_30" />
                            <path d={is4 ? svgPaths.p15cc0af0 : svgPaths.p29b0b980} fill="var(--fill-0, white)" id="Vector_31" />
                            <path d={is4 ? svgPaths.p21c13400 : svgPaths.pc23700} fill="var(--fill-0, #90DEC0)" id="Vector_32" />
                            <path d={is4 ? svgPaths.p1e6bb80 : svgPaths.p15a92900} fill="var(--fill-0, #00AB6B)" id="Vector_33" />
                            <path d={is4 ? svgPaths.p3204f400 : svgPaths.p94fca00} fill="var(--fill-0, #00AB6B)" id="Vector_34" />
                            <path d={is4 ? svgPaths.p26261400 : svgPaths.p38aa6300} fill="var(--fill-0, #00AB6B)" id="Vector_35" />
                            <path d={is4 ? svgPaths.p39a2800 : svgPaths.pd6d0980} fill="var(--fill-0, #00AB6B)" id="Vector_36" />
                            <path d={is4 ? svgPaths.p30ce56f0 : svgPaths.p3fc8a080} fill="var(--fill-0, #90DEC0)" id="Vector_37" />
                          </g>
                        </svg>
                      </div>
                    </div>
                          ...
                          <div className="flex flex-col items-center justify-center size-full">
                            <div className="content-stretch flex flex-col items-center justify-center px-[12.8px] py-[7.68px] relative size-full">
                              <div className="content-stretch flex gap-[2.56px] items-center justify-center relative shrink-0" data-name="Container">
                                <p className="font-['Proxima_Nova:Bold',sans-serif] leading-[1.35] not-italic relative shrink-0 text-[8.96px] text-center text-white whitespace-nowrap">{is4 ? "Oke" : ["2", "3", "5"].includes(state) ? "Button" : "Button"}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className="content-stretch flex flex-col gap-[17.194px] items-start relative shrink-0 w-full">
                  <div className="content-stretch flex gap-[11.463px] items-start relative shrink-0 w-full">
                    <div className="relative shrink-0 size-[51.582px]" data-name="Images / Example 2">
                      <div className="absolute inset-[-2.78%_-52.78%_-4.17%_-15.28%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[11px_2px] mask-size-[72px_72px]" data-name="shutterstock_1716494026 1" style={is4 ? { maskImage: `url('${imgShutterstock17164940261}')` } : { maskImage: `url('${imgImagesExample2}')` }}>
                        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImagesExample3} />
                      </div>
                    </div>
                  ...
                  <div className="content-stretch flex gap-[11.463px] items-start relative shrink-0 w-full">
                    <div className="relative shrink-0 size-[51.582px]" data-name="Images / Example 1">
                      <div className="absolute inset-[-1.39%_-43.06%_-2.78%_-12.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[9px_1px] mask-size-[72px_72px]" data-name="shutterstock_533579002 1" style={is4 ? { maskImage: `url('${imgShutterstock17164940261}')` } : { maskImage: `url('${imgImagesExample2}')` }}>
                        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImagesExample1} />
                      </div>
                    </div>
                    <BibitSahamFrame text="Tetap Tenang di tengah Pasar yang Bergejolak karena Cor..." text1="CNBC News" text2="5j" />
                  </div>
                  <div className="content-stretch flex gap-[11.463px] items-start relative shrink-0 w-full">
                    <div className="relative shrink-0 size-[51.582px]" data-name="Images / Example 4">
                      <div className="absolute inset-[-0.72%_-2.5%_-5.07%_-2.5%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[1.8px_0.522px] mask-size-[72px_72px]" data-name="shutterstock_1779839804" style={is4 ? { maskImage: `url('${imgShutterstock1779839804}')` } : { maskImage: `url('${imgImagesExample4}')` }}>
                        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImagesExample5} />
                      </div>
                    </div>
                    <BibitSahamFrame text="Tetap Tenang di tengah Pasar yang Bergejolak karena Cor..." text1="CNBC News" text2="5j" />
                  </div>
                  ...
                  <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
                    ...
                    <div className="col-1 ml-[5.25px] mt-[5.25px] overflow-clip relative row-1 size-[14px]" data-name="Return">
                      <div className="absolute bottom-1/4 left-[4.17%] right-[4.17%] top-1/4" data-name="Vector">
                        <div className={`absolute ${is4 ? "inset-[-8.04%_-4.38%]" : "inset-[-6.25%_-3.41%]"}`}>
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 13.9583 8.125" : "0 0 23.5 13.5"}>
                            <path d={is4 ? svgPaths.p3a334058 : svgPaths.p2d26d180} id="Vector" stroke={is4 ? "var(--stroke-0, #00AB6B)" : "var(--stroke-0, #01F4A6)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "1.125" : "1.5"} />
                          </svg>
                        </div>
                      </div>
                      <div className="absolute bottom-1/2 left-[70.83%] right-[4.17%] top-1/4" data-name="Vector">
                        <div className={`absolute ${is4 ? "inset-[-16.07%]" : "inset-[-12.5%]"}`}>
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 4.625 4.625" : "0 0 7.5 7.5"}>
                            <path d={is4 ? "M0.5625 0.5625H4.0625V4.0625" : "M0.75 0.75H6.75V6.75"} id="Vector" stroke={is4 ? "var(--stroke-0, #00AB6B)" : "var(--stroke-0, #01F4A6)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "1.125" : "1.5"} />
                          </svg>
                        </div>
                      </div>
                    </div>
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute content-center flex flex-wrap gap-[72px] items-center justify-center left-1/2 top-[calc(50%-0.13px)]">
            ...
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
              ...
              <div className="col-1 ml-[15.75px] mt-[15.75px] overflow-clip relative row-1 size-[42px]" data-name="Return">
                <div className="absolute bottom-1/4 left-[4.17%] right-[4.17%] top-1/4" data-name="Vector">
                  <div className={`absolute ${is4 ? "inset-[-7.14%_-3.9%]" : "inset-[-6.25%_-3.41%]"}`}>
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 41.5 24" : "0 0 23.5 13.5"}>
                      <path d={is4 ? svgPaths.p2e0945c0 : svgPaths.p2d26d180} id="Vector" stroke={is4 ? "var(--stroke-0, white)" : "var(--stroke-0, #01F4A6)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "3" : "1.5"} />
                    </svg>
                  </div>
                </div>
                <div className="absolute bottom-1/2 left-[70.83%] right-[4.17%] top-1/4" data-name="Vector">
                  <div className={`absolute ${is4 ? "inset-[-14.29%]" : "inset-[-12.5%]"}`}>
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox={is4 ? "0 0 13.5 13.5" : "0 0 7.5 7.5"}>
                      <path d={is4 ? "M1.5 1.5H12V12" : "M0.75 0.75H6.75V6.75"} id="Vector" stroke={is4 ? "var(--stroke-0, white)" : "var(--stroke-0, #01F4A6)"} strokeLinecap="round" strokeLinejoin="round" strokeWidth={is4 ? "3" : "1.5"} />
                    </svg>
                  </div>
                </div>
              </div>
...
export default function BibitSaham1() {
  return <BibitSaham className="bg-white relative size-full" state="4" />;
}