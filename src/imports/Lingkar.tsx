...
import svgPaths from "./svg-lehy40f0kh";
...
type LingkarBadgeTextProps = {
  text: string;
};

function LingkarBadgeText({ text }: LingkarBadgeTextProps) {
  return (
...
export default function Lingkar() {
  return (
      ...
      <div className={`absolute content-stretch flex flex-col items-start left-0 w-[510px] ${"1" === "5" ? "bottom-0" : "1" === "4" ? "top-[-1503px]" : "1" === "3" ? "top-[-1002px]" : "1" === "2" ? "top-[-501px]" : "top-0"}`}>
                    ...
                    <div className="-scale-y-100 flex-none rotate-180">
                      <div className="content-stretch flex flex-col gap-[8px] items-start relative" data-name="name">
                        <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
                          <LingkarBadgeText text="bekasi" />
                          <LingkarBadgeText text="arsitek" />
                        </div>
        ...
        <div className="aspect-[650/650] overflow-clip relative shrink-0 w-full" data-name="bibit">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute content-center flex flex-wrap gap-[15px] items-center justify-center left-1/2 top-[calc(50%+0.26px)] w-[480px]">
            ...
            <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
              <LingkarBadgeText text="Cibubur" />
              <LingkarBadgeText text="Interior" />
              <LingkarBadgeText text="2025" />
            </div>
            <div className="content-stretch flex gap-[8px] items-start relative shrink-0">
